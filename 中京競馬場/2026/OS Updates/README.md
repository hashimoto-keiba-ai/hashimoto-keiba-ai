...
Racecourse-specific operating system updates for Chukyo.

## OS Updates Manager

Use the Phase8-5 OS Updates Manager to store Chukyo OS rules in localStorage and connect them back to this racecourse database.
