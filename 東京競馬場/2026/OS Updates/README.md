...
Racecourse-specific operating system updates for Tokyo.

## OS Updates Manager

Use the Phase8-5 OS Updates Manager to store Tokyo OS rules in localStorage and connect them back to this racecourse database.
