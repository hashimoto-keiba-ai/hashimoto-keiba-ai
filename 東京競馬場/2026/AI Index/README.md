...
Race-specific AI index database for Tokyo.

## AI Index Manager

Use the Phase8-6 AI Index Manager to store Tokyo horse-level AI index entries in localStorage and connect them back to this racecourse database.
