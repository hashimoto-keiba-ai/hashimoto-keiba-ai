...
Racecourse-specific operating system updates for Hanshin.

## OS Updates Manager

Use the Phase8-5 OS Updates Manager to store Hanshin OS rules in localStorage and connect them back to this racecourse database.
