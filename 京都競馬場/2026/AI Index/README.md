...
Race-specific AI index database for Kyoto.

## AI Index Manager

Use the Phase8-6 AI Index Manager to store Kyoto horse-level AI index entries in localStorage and connect them back to this racecourse database.
