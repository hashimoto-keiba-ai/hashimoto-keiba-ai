...
assert.equal(engine.VERSION, '2.7', 'AI秘書のバージョンが2.7である');
assert.deepEqual(engine.SOURCE_KEYS, ['integrated-os.json', 'prediction-engine.json', 'learning-engine.json', 'return-ai-db.json', 'history-db.json'], '指定DBと連携する');
...
assert.equal(saved.version, '2.7', 'ai-secretary-db.jsonへv2.7として保存する');
