...
assert.strictEqual(readyReport.releaseScore, 102);
...
const problemReport = createEngine(problemSeed, { aiRanking: 72, holeRanking: 70, riskRanking: 69, ticketEngine: 67, win5: 71, raceDatabase: 66, courseDatabase: 60, distanceDatabase: 60, profitDatabase: 60, returnAiDatabase: 60, favoriteZoneAi: 60, jockeyAi: 60, trainerAi: 60, integrationDashboard: 68, versionManager: 70 }).generateReport();
