...
assert.strictEqual(
  JSON.stringify(engine.racecourses),
  JSON.stringify(["Tokyo", "Nakayama", "Hanshin", "Kyoto", "Chukyo", "Fukushima", "Niigata", "Kokura", "Hakodate", "Sapporo"])
);
assert.strictEqual(
  JSON.stringify(engine.betTypes),
  JSON.stringify(["Win", "Place", "Exacta", "Quinella", "Trifecta", "WIN5"])
);
assert.strictEqual(
