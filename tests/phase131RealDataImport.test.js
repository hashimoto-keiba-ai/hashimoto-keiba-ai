...
const csvPreview = importer.previewImport({ text: csv, format: "CSV", dataType: "Prediction Logs", racecourse: "Tokyo", sourceName: "sample.csv" });
...
const invalidPreview = importer.previewImport({ text: "racecourse,raceName,horseNumber,horseName,aiScore,popularity\n,Tokyo 11R,,AI Commander,120,0", format: "CSV", dataType: "Prediction Logs", racecourse: "Tokyo", sourceName: "invalid.csv" });
