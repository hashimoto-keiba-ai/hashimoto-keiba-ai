...
for (const db of engine.DATABASE_FILES) {
  ...
  const expectedPhase = db.startsWith("global-network-simulation-log-") || db.startsWith("global-network-audit-trail-") ? "Phase18-16" : db.startsWith("global-network-safety-") || db.startsWith("global-network-preconnection-") ? "Phase18-15" : db.startsWith("global-network-node-sync-") || db.startsWith("global-network-dependency-") ? "Phase18-14" : db.startsWith("global-intelligence-network-") ? "Phase18-13" : db.startsWith("global-network-") ? "Phase18-12" : db.startsWith("global-intelligence-control-center-") ? "Phase18-11" : db.startsWith("final-safety-") || db.startsWith("release-readiness-") ? "Phase18-10" : db.startsWith("governance-") ? "Phase18-9" : db.startsWith("repair-governance-") ? "Phase18-8" : db.startsWith("repair-audit-") || db.startsWith("repair-rollback-") ? "Phase18-7" : db.startsWith("repair-approval-") ? "Phase18-6" : db.startsWith("self-repair-") ? "Phase18-5" : "Phase18-4";
