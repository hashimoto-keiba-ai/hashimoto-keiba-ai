...
assert.equal(engine.ENGINE_MENU.length, 10);
assert.equal(engine.ONE_TAP_MENU.length, 12);
...
assert.equal(storage.readJson(engine.DATABASES.menu).oneTapMenu.length, 12);
