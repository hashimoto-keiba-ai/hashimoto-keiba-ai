...
Racecourse-specific operating system updates for Sapporo.

## OS Updates Manager

Use the Phase8-5 OS Updates Manager to store Sapporo OS rules in localStorage and connect them back to this racecourse database.
