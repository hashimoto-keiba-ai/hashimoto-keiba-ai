(() => {
  ...
  const api = { VERSION, STORAGE_KEY, SOURCE_KEYS, QUESTIONS, buildSecretaryMemo, saveSecretaryMemo, buildSecretaryStatus, answerQuestion, renderSecretary, bindSecretary };
