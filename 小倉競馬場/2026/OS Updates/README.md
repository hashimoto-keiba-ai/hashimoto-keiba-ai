...
Racecourse-specific operating system updates for Kokura.

## OS Updates Manager

Use the Phase8-5 OS Updates Manager to store Kokura OS rules in localStorage and connect them back to this racecourse database.
